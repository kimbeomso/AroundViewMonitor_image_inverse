...
XY_coord InvProjGND(double X_W,double Y_W,double ROLL,double PITCH, double YAW, double World_CamX,double World_CamY,double World_CamZ, struct ocam_model *o);